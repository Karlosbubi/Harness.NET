    ...
    : IInboundMcpSettingsStore
{
    private static readonly HashSet<string> KnownTools = new(StringComparer.Ordinal)
    {
        ...
        "harness_git", "harness_git_history", "harness_git_commit", "harness_git_blame",
        "harness_project_graph", "harness_goals", "harness_evidence",
        ...
        "harness_abort_goal", "harness_decide_plan", "harness_commit_preview",
        "harness_request_commit", "harness_decide_commit",

...
internal static class KeybindingCatalog
{
    ...
    [
        ...
        new(KeybindingCommand.BuildStartupProject, "Solution", "Build startup project"),
        new(KeybindingCommand.RebuildStartupProject, "Solution", "Rebuild startup project"),
        new(KeybindingCommand.RefreshTestExplorer, "Tests", "Refresh Test Explorer"),

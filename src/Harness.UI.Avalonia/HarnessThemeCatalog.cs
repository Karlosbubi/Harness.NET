...
public static class HarnessThemeCatalog
{
    ...
    private static IReadOnlyDictionary<UiThemeColorToken, string> Palette(bool isDark) =>
        new Dictionary<UiThemeColorToken, string>
        {
            ...
            [UiThemeColorToken.CodeComment] = isDark ? "#8EBD86" : "#3E7138",
            [UiThemeColorToken.CodeNumber] = isDark ? "#B9A1F7" : "#6543A5",
            [UiThemeColorToken.CodeMethod] = isDark ? "#E7D58A" : "#685A00",
            [UiThemeColorToken.CodeNamespace] = isDark ? "#95D6E8" : "#17627A",
            [UiThemeColorToken.CodeProperty] = isDark ? "#9EDAF2" : "#1A5C78",
            [UiThemeColorToken.CodeField] = isDark ? "#B5C8E8" : "#36557B",
            [UiThemeColorToken.CodeParameter] = isDark ? "#D7B9F2" : "#69478A",
            [UiThemeColorToken.CodeLocal] = isDark ? "#D7D2DF" : "#49444F",
            [UiThemeColorToken.CodePreprocessor] = isDark ? "#D69BE8" : "#7A3C8A",
            [UiThemeColorToken.CodePunctuation] = isDark ? "#C8C4CF" : "#514C57",

...
| `verify-local-model-regression.py` | Deterministic regression corpus; `--live` explicitly enables local Ollama comparisons. | Python 3; Ollama only for explicit live mode. | Task 038 regression record. | <1 min fixtures; model-dependent live |

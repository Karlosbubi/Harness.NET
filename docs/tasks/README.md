...
has extracted run output, Problems, the Roslyn lifecycle, editor interactions, exact
rename, and deterministic transformations; remaining document hosting and slices
060.6–060.8 remain.

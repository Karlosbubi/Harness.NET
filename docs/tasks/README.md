...
| 033 | In progress | Pass docked-workbench product acceptance | 030-032 | Real wide and minimum-size Linux empty states are recorded; rendered center-editor attachment, compact keyboard restoration, explicit automation names, floating ownership, and 200% scaling pass deterministically. Hands-on screen-reader and the complete restart/corruption/multi-document representative workflow matrix remain open. |

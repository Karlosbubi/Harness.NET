...
recovery and explicit local-branch handoff. The remaining Stage 3 daily-use gap is
in-app backup restore (Task 041). Task 038 remains deferred until that closes.

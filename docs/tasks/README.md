...
has extracted run output, Problems, the Roslyn lifecycle, editor interactions, and
exact semantic rename; remaining document hosting and slices 060.6–060.8 remain.

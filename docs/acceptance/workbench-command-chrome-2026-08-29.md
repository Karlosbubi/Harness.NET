...
- `WorkbenchPaletteCatalog` maps 49 core actions from Solution, Tests, Files, Git changes, branches,
...
- Deterministic coverage compares the 49-action catalog directly with the typed enum

...
| Organize/fix usings | Code actions | Refactoring services | Partial | Import sorting/grouping is delivered through the same closed transformation path. Unused-import removal and missing-import fixes remain with code actions |
